...
int red[3]    = { 100, 0, 0 };
int pink[3]    = { 100, 21, 86 };
int green[3]  = { 0, 100, 0 };
int blue[3]   = { 0, 0, 100 };
int yellow[3] = { 40, 95, 0 };
int orange[3] = { 100, 55, 37 };
...
float readTemperature()
{
 ...
 float temperatureC = (5.0 * reading *100) / 1024 ;  //converting from 10 mv per degree wit 500 mV offset
 ...
 float tempPC = ((temperatureC - coolTemp) / (hotTemp - coolTemp));
 
 if (temperatureC < coolTemp)
 {
   tempPC = 0;
 }
 ...
 Serial.print(tempPC); Serial.println(" temp scale");
 return tempPC;
}

void displayTemperature()
{
  float tempColour = readTemperature();
  int redVal = 100 * tempColour;
  int blueVal = 100 - (tempColour*100);
  int greenVal = 0;
